using LTT_WPF_Application.Properties;
        ...
        private void Application_Startup(object sender, StartupEventArgs e)
        {
            ...
            try
            {
                if (!string.IsNullOrWhiteSpace(Settings.Default.LogPath))
                {
                    ...
                    ServiceLocator.Instance.Logger.LogFile = Path.Combine(Settings.Default.LogPath, "LTT_WPF_Application.log");
                }
                else
                {
                    ...
                    {
                        ServiceLocator.Instance.Logger.LogFile = Path.Combine(location, "LTT_WPF_Application.log");
                    }
                }
            }
            catch
            {
                ...
                ServiceLocator.Instance.Logger.LogFile = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory), "LTT_WPF_Application.log");
            }
